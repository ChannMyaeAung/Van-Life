...
const Home = () => {
  return (
    <section>
      <article className={`relative h-screen ${styles.flexColumnCenter}`}>
        ...
        {/* Main Content */}
        <div
          className={`${styles.flexColumnCenter} z-50 px-10 gap-5 md:gap-10`}
        >
          ...
          <NavLink
            to={`vans`}
            className={`${styles.flexColumnCenter} flex-col primary__cta-btn`}
          >
            Find your van
          </NavLink>
        </div>
